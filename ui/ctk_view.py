...
class CTkView(View):
    ...
    def __init__(self, controller: Controller = None):
        ...
        self.current_page: Page = HomeView(self.root, controller=self.controller)
    ...
    def update(self, data=None):
        ...
        if next_page_type == self.current_page_type:
            ...
            if next_page_type == PageType.MAIN_PAGE:
                ...
                self.current_page = NewEntryView(self.root, controller=self.controller)
            elif next_page_type == PageType.VIEW_ENTRIES_PAGE:
                self.current_page = EntryListView(self.root, controller=self.controller)
            else:
                self.current_page = HomeView(self.root, controller=self.controller)
